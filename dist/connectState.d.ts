 ...
 */
export declare const connectState: <StateInstance extends Galena<any>>(state: StateInstance) => <SelectorFunction extends (state: StateInstance["state"], ownProps: any) => Record<string, any>>(selection: SelectorFunction) => <ComponentProps extends ReturnType<SelectorFunction>>(WrappedComponent: ComponentType<ComponentProps>) => ComponentType<Subtract<ComponentProps, ReturnType<SelectorFunction>>>;
